...
p_values = np.linspace(0, 1, 152)[1:-1]      # Provides several values (ordered) between 0 and 1, where 0 and 1 are removed
...
for p in p_values:
    ...
    if valid_outbreaks != 0:
        ...
        # plt.hist(sizes_combined, bins = bin_edges, density = True, alpha= 0.7, edgecolor = 'black') 
        ...
        # plt.show()
    # else:
    #     print(f'p = {p:.2f}: lambda is not defined')
